  ...
  return (
    <aside className="hidden w-72 shrink-0 rounded-3xl border border-slate-200 bg-white/80 p-5 shadow-sm backdrop-blur lg:block">
      <div className="rounded-2xl bg-slate-900 p-4 text-white">
        <p className="text-sm text-slate-300">Student learning hub</p>
        <p className="mt-1 text-xl font-semibold">Keep growing every day</p>
      </div>

      <nav className="mt-6 space-y-1" aria-label="Student navigation">
